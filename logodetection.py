...
class LogoDetectionInVideo:
    ...
    def upload_json_to_deliveries(self, logo_detections):
        ...
        try:
            ...
            # self.logger.log('INFO', "JSON file already exists",
            #           self.upload_json_to_deliveries.__name__)
            ...
            print(e)
            final_data = {}
            # self.logger.log('INFO', "json file does not exists: %s" %
                    #   e, self.upload_json_to_deliveries.__name__)
